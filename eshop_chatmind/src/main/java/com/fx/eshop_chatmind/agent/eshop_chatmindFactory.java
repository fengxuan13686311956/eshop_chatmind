package com.fx.eshop_chatmind.agent;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fx.eshop_chatmind.agent.tools.Tool;
import com.fx.eshop_chatmind.config.ChatClientRegistry;
import com.fx.eshop_chatmind.converter.AgentConverter;
import com.fx.eshop_chatmind.converter.ChatMessageConverter;
import com.fx.eshop_chatmind.converter.KnowledgeBaseConverter;
import com.fx.eshop_chatmind.mapper.AgentMapper;
import com.fx.eshop_chatmind.mapper.KnowledgeBaseMapper;
import com.fx.eshop_chatmind.model.dto.AgentDTO;
import com.fx.eshop_chatmind.model.dto.ChatMessageDTO;
import com.fx.eshop_chatmind.model.dto.KnowledgeBaseDTO;
import com.fx.eshop_chatmind.model.entity.Agent;
import com.fx.eshop_chatmind.model.entity.KnowledgeBase;
import com.fx.eshop_chatmind.service.ChatMessageFacadeService;
import com.fx.eshop_chatmind.service.SseService;
import com.fx.eshop_chatmind.service.ToolFacadeService;
...
@Component
public class eshop_chatmindFactory {

    private static final Logger log = LoggerFactory.getLogger(eshop_chatmindFactory.class);
    ...
    private eshop_chatmind buildAgentRuntime(
            Agent agent,
            List<Message> memory,
    ...
    /**
     * 创建一个 eshop_chatmind 实例
     */
    public eshop_chatmind create(String agentId, String chatSessionId) {
