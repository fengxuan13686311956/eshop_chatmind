...
import com.fx.eshop_chatmind.agent.AgentState;
 ...
 */
@Slf4j
public class eshop_chatmindV2 extends eshop_chatmindV1 {
    ...
    public eshop_chatmindV2() {
        super();
    }
    
    public eshop_chatmindV2(String name,
                      String description,
                      String systemPrompt,
