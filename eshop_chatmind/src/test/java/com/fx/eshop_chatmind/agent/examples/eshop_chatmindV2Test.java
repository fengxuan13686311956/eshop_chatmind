package com.fx.eshop_chatmind.agent.examples;

import com.fx.eshop_chatmind.agent.tools.test.CityTool;
import com.fx.eshop_chatmind.agent.tools.test.DateTool;
import com.fx.eshop_chatmind.agent.tools.test.WeatherTool;
...
/**
 * eshop_chatmindV2 测试类
 * 测试工具调用功能（ReAct 模型）
 */
@SpringBootTest
public class eshop_chatmindV2Test {
    ...
    public void testToolCalling() {
        ...
        // 创建 V2 实例
        eshop_chatmindV2 agent = new eshop_chatmindV2(
                "test-agent-v2",
                "测试 Agent V2",
